...
# Divido il campione in tre sotto-popolazioni in base all'età
age_bins = [0, 1, 5, 13.56]
labels = ['< 1 Gyr', '1-5 Gyr', '> 5 Gyr']

# Creao tre sottoinsiemi di metallicità in base all'età
...
# Creao tre sottoinsiemi di metallicità e massa in base all'età
metallicita_subsets = [[] for _ in range(len(labels))]
...
# Disegno i grafici a dispersione per ciascuna popolazione
plt.figure(figsize=(10, 6))
colors = ['midnightblue', 'crimson', 'lime']
